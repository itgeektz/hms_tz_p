...
frappe.query_reports["Insurance Claim Tracking Report1"] = {
	"filters": [
	...
	'formatter': (value, row, column, data, default_formatter) => {
		...
		if ((data.regency_insurance_claim != '' && data.regency_insurance_claim != null) && (data.signature == '' || data.signature == null)) {
