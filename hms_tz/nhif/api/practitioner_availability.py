...
from hms_tz.nhif.doctype.practitioner_availability_detail.practitioner_availability_detail import (
    create_practitioner_availability_detail,
    delelte_all_related_practitioner_availability_detail,
)
