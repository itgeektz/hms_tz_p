...
class PatientProgress {
	...
	get_therapy_sessions_count() {
		return frappe.xcall(
			'hms_tz.hms_tz.page.patient_progress.patient_progress.get_therapy_sessions_count', {
	...
	update_heatmap_data(date_from) {
		frappe.xcall('hms_tz.hms_tz.page.patient_progress.patient_progress.get_patient_heatmap_data', {
			patient: this.patient_id,
	...
	render_percentage_chart(field, title) {
		frappe.xcall(
			'hms_tz.hms_tz.page.patient_progress.patient_progress.get_therapy_sessions_distribution_data', {
				patient: this.patient_id,
				field: field
			}
		).then(chart => {
	...
	render_therapy_progress_chart(time_span='Last Month') {
		...
		frappe.xcall(
			'hms_tz.hms_tz.page.patient_progress.patient_progress.get_therapy_progress_data', {
				patient: this.patient_id,
	...
	render_assessment_result_chart(time_span='Last Month') {
		...
		frappe.xcall(
			'hms_tz.hms_tz.page.patient_progress.patient_progress.get_patient_assessment_data', {
				patient: this.patient_id,
	...
	render_therapy_assessment_correlation_chart(time_span='Last Month') {
		...
		frappe.xcall(
			'hms_tz.hms_tz.page.patient_progress.patient_progress.get_therapy_assessment_correlation_data', {
				patient: this.patient_id,
	...
	render_assessment_parameter_progress_chart(time_span='Last Month') {
		...
		frappe.xcall(
			'hms_tz.hms_tz.page.patient_progress.patient_progress.get_assessment_parameter_data', {
				patient: this.patient_id,
