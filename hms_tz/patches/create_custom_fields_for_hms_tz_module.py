...
def execute():
    ...
    examination_field = frappe.get_doc(
        "Custom Field", "Patient Encounter-examination_detail"
    )
    examination_field.mandatory_depends_on = (
        "eval:!doc.practitioner.includes ('Direct')"
    )
